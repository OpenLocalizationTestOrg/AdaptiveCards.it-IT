...
Di seguito viene illustrato come eseguire il rendering di una scheda con iOS SDK.
...
Il UIView restituito usa il layout automatico. La larghezza sarà vincolata al valore impostato da widthConstraint. Se si usa il valore 0, non verrà associato.
L'altezza non è associata e, quando viene restituita, avrà l'altezza di tutte le somme di tutti i contenuti sottoposti a rendering. Per associare la dimensione di visualizzazione, usare NSLayoutConstraint. La dimensione esatta è accessibile dal contesto di viewDidLayoutSubview del ViewController di supervisione o del relativo metodo con lo stesso nome se viene usato ACRViewController.
