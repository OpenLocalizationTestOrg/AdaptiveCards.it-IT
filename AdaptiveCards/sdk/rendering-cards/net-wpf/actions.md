...
Tutti `actions` gli elementi all'interno della scheda verranno `Button`visualizzati come WPF, ma spetta all'app gestire cosa accade quando un utente la preme. 

L' `RenderedAdaptiveCard` oggetto fornisce un `OnAction` evento a questo scopo.
